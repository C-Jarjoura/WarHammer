...
Astartes Astartes::creerDevastator(char s) {
    Astartes a(s);
    a.atk = 4; a.hit = 3; a.def = 3; a.dgt = 8; a.pv = 16; a.mvt = 5;
    a.armes.clear();
